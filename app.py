...
app.layout = html.Div(children=[
    ...
    html.Button('Show Analysis', id='submit-button', n_clicks=0, disabled=True),
...
def set_button_enabled(input_type, input_year):
    if input_type and input_year:
        return False
    return True
...
def get_graph(n_clicks, chart, year, children1, children2, c3, c4, c5):
    if not n_clicks:
    ...
    if chart == 'OPT1':
        ...
        map_fig = px.choropleth(map_data, locations='OriginState', color='Flights',
                                ...
                                color_continuous_scale='GnBu', range_color=[0, map_data['Flights'].max()])
